...
<style>    
            ...
            .btncalendar{display:inline-block;width:22px;height:22px;background:url(img/btn_calendar.gif) center center no-repeat;text-indent:-999em}
		...
		<div id="saleListCon">
			...
			<div id="sl-top">
				<div id="sale-date-con"><!-- 큰한줄 -->					
					<div id="dateType"> 
					<input type="date" id="dateFrom" name="from" > ~ <input type="date" id="dateTo" name="to"> </div> 
					<div> 
