...
<div class="containers">
	<div class="formdiv">
		...
		<div class="anotherlogindiv">
			<div class="anotherlogin" ><a id="kakaologin"></a></div>
			<div class="anotherlogin" id="naverlogin">네이버 로그인</div>
...
var naverLogin = new naver.LoginWithNaverId(
		{
			...
			callbackUrl: "http://localhost:9090", // 내 애플리케이션 API설정의 Callback URL 을 입력해줍니다.
			isPopup: false,
			callbackHandle: true
		}
	);	
